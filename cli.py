"""Minimal CLI test flow for the data layer (data_manager.py).

Kept from Day 1 as a lightweight way to poke at the data layer from a
terminal without launching the GUI. The GUI (gui.py) is the primary
interface as of Day 2 -- run main.py for that.
"""
